...
class Level1 extends Level {
  object Level1Constants {
    ...
    val INIT_BALL_VEL = new ImmutableVector2f(0f, 40f)//randBallVector
  ...
  override def blockCollection: Seq[RedBrick] = Level1Constants.BLOCK_COLLECTION
  ...
  override def initialLifeCount: Int = 1
}